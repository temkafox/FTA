"""PoE 1 release with a continuously colored ascendancy route."""
...
import release_poe1_v22 as previous
...
from actpilot.overlay import ConnectedAscendancyOverlay
...
def main():
    ...
    window = ConnectedAscendancyOverlay()
    window.show()
    sys.exit(app.exec_())
