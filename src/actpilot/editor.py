"""Живая линия ручного редактора билда: ManualBuildEditor v1..v11 и его канвасы/диалоги."""
...
from actpilot.tree import ExplicitProgressionTreeCanvas
from actpilot.tree import ZoomScaledNodeMixin
...
class ManualBuildEditor(ManualBuildEditorV10):
    def __init__(self, overlay, parent=None):
...
ManualBuildEditorV11 = ManualBuildEditor
